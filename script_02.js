...
const books = [
  ...
  function titles() {
      books.filter( book => console.log(book.title));
  };
  ...
  function isrented() {
      books.map( book => {
          if(book.rentedCount > 0) {
              ...
              console.log(`Ce livre n'a jamais été emprunté : ${book.title}`);
          }
      })
    };
   ...
   function big_rented(){
    console.log(books.reduce(function(a, b) {
     return  a.rentedCount > b.rentedCount ? a : b;
    }))};
    

    /* Quel est le livre le moins emprunté ? */

    function small_rented(){
        console.log(books.reduce(function(a, b) {
         return  a.rentedCount < b.rentedCount ? a : b;
        }))};
